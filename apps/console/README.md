...
|--------|------------------------|---------|----------------|-------|
| 1 | A1 – Iniciar sesión desde centro de pruebas | ✅ Terminado | Equipo de Desarrollo| Validación simple lista |
| 1 | A2 – Presentar prueba selección múltiple | ✅ Terminado | Equipo de Desarrollo | Base central en construcción |
| 2 | A3 – Preguntas cortas y ensayo | ✅ Terminado | Equipo de Desarrollo | Depende de A2 |
| 2 | B1 – Calificación de ensayos pendientes | ✅ Terminado | Equipo de Desarrollo | Planificado para sprint 2 |
| 3 | B2 – Consolidar resultados finales | ✅ Terminado | Equipo de Desarrollo | Desarrollado durante Sprint 3 |
| 3 | C1 – Reporte básico para administradores | ✅ Terminado / En pruebas | Equipo de Desarrollo | Sprint 3 |

---

### 3. Sprint Backlog (Estimación) 🃏  
📝 Sprint Backlog – Aplicación de pruebas

| Historia | Tarea | Estado | Responsable |
|----------|-------|--------|-------------|
| A1 – Iniciar sesión estudiante | Conceder acceso solo a usuarios válidos | To Do | Equipo de Desarrollo |
| A1 – Iniciar sesión estudiante | Validar usuario/clave contra centro de pruebas configurado | To Do | Equipo de Desarrollo |
| A1 – Iniciar sesión estudiante | Mostrar mensaje de error claro (“usuario/clave inválidos”) | To Do | Equipo de Desarrollo |
| A2 – Presentar prueba selección múltiple | Cargar preguntas desde base central | To Do | Equipo de Desarrollo |
| A2 – Presentar prueba selección múltiple | Permitir solo una respuesta por estudiante | To Do | Equipo de Desarrollo |
| A2 – Presentar prueba selección múltiple | Calcular puntaje automático en tiempo real | To Do | Equipo de Desarrollo |
| A2 – Presentar prueba selección múltiple | Enviar y registrar examen con éxito | To Do | |
| A3 – Preguntas cortas y ensayo | Habilitar campos de texto editables | To Do | Equipo de Desarrollo |
| A3 – Preguntas cortas y ensayo | Guardar respuestas de forma segura (persistencia al recargar) | To Do | Equipo de Desarrollo |
| A3 – Preguntas cortas y ensayo | Envío exitoso adjunta todo el contenido al examen | To Do | Equipo de Desarrollo |
| B1 – Calificación manual | Mostrar lista solo con respuestas pendientes | To Do | Equipo de Desarrollo |
| B1 – Calificación manual | Permitir asignar nota numérica | To Do | Equipo de Desarrollo |
| B1 – Calificación manual | Guardar nota en base sin pérdida de datos | To Do | Equipo de Desarrollo |
| B2 – Consolidación automática | Sumar puntaje automático + manual | To Do | Equipo de Desarrollo |
| B2 – Consolidación automática | Generar nota final única por estudiante | To Do | Equipo de Desarrollo |
| B2 – Consolidación automática | Almacenar consolidado en base centralizada sin duplicados | To Do | Equipo de Desarrollo |
| C1 – Reporte básico | Mostrar lista de estudiantes que presentaron examen | To Do | Equipo de Desarrollo |
| C1 – Reporte básico | Incluir nombre, colegio y puntaje final | To Do | Equipo de Desarrollo |
| C1 – Reporte básico | Permitir filtro por colegio | To Do | Equipo de Desarrollo |

---
### 4. Burndown Chart 📉  
📉 Burndown Chart

Aquí se presentan los gráficos de avance de los sprints, mostrando la evolución de las tareas pendientes en cada iteración del Scrum.

### Sprint 1
<img src="https://i.ibb.co/XxWv8BjL/sprint-1.jpg" alt="sprint-1" border="0"><br />

### Sprint 2
<img src="https://i.ibb.co/GQ3SLBTF/sprint-2.jpg" alt="sprint-2" border="0"><br />

### Sprint 3
<img src="https://i.ibb.co/3mMqwggs/sprint-3.jpg" alt="sprint-3" border="0"><br />

---

### 5. Reunión Diaria y Review 🤝  

[![Ver en YouTube](https://img.youtube.com/vi/figNDXE0p8M/0.jpg)](https://www.youtube.com/watch?v=figNDXE0p8M)
